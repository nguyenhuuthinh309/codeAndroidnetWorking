    ...
    void selectData(){
        ...
        call.enqueue(new Callback<SvrResponseSelect>() {
            ...
            public void onResponse(Call<SvrResponseSelect> call, Response<SvrResponseSelect> response) {
                ...
                String jsonData = String.valueOf(ls);
                Prd[] students = new Gson().fromJson(jsonData, Prd[].class);

                for(Prd student : students) {
                    kq +="ID:"+student.getKhunggio()+"; Name: "+student.getTenkhach()+
                            "; Price: "+student.getTongtien()+
                            "; Des: "+student.getSdt()+"\n";
                }
